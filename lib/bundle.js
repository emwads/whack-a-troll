...
/***/ function(module, exports, __webpack_require__) {
	...
	const GameControl = function (ctx) {
	  ...
	  this.gameTime = 10000; //Game length in milliseconds
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	GameParts.prototype.addCritter = function () {
	...
	GameParts.prototype.addSingleCritter = function (troll) {
	  ...
	  this.critters.push(
	    new Critter( {pos: pos, gameParts: this, img: img,
	                  points: points, life:lifeSpan})
	  );
	};
	...
	GameParts.prototype.addCritters = function(){
	  ...
	  const refreshTime = Math.random() * (2000 - 500) + 500;
	
	  if (this.trolling) {
	    window.setInterval(this.addCritters.bind(this), refreshTime);
	  }
	};
...
/***/ function(module, exports) {
	...
	const Critter = function (options) {
	  ...
	  this.hit = false;
	   ...
	   window.setInterval(this.remove.bind(this), options.life);
	};
